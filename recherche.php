      ...
      if (empty($search)) {
        ...
        if (count($results) > 0 || count($results1) > 0 || count($results2) > 0 || count($results3) > 0) {
          ...
          foreach ($results as $result) {
            echo "<li><a href=\"activites.php?id=" . $result['id'] . "\">" . $result['nom'] . "</a></li>";
          }
          echo "<h3> Résultat pour les Entreprises : </h3>";
          foreach ($results1 as $result) {
            echo "<li><a href=\"entreprises.php?id=" . $result['id'] . "\">" . $result['nom'] . "</a></li>";
          }
          echo "<h3> Résultat pour les Événements : </h3>";
          foreach ($results2 as $result) {
            echo "<li><a href=\"evenements.php?id=" . $result['id'] . "\">" . $result['nom'] . "</a></li>";
          }
          echo "<h3> Résultat pour les Forfaits : </h3>";
          foreach ($results3 as $result) {
            echo "<li><a href=\"forfaits.php?id=" . $result['id'] . "\">" . $result['nom'] . "</a></li>";
          }
          echo "</ul>";
        } else {
